...
Date: 2025-11-24 19:49:33
LastEditors: duyulin@kingsoft.com
LastEditTime: 2025-11-24 19:54:50
FilePath: \stock_arbitrage\deepseek_client.py
Description: 
...
mcp = FastMCP("deepseek-client", json_response=True)


@mcp.tool()
def deepseek_chat(prompt: str, model: str = "deepseek-chat", system: str | None = None, max_tokens: int | None = None) -> dict[str, Any]:
    return chat(prompt, model, system, max_tokens)
